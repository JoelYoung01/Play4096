...
INSERT INTO `__new_game`("id", "player_id", "created_on", "completed_on", "score", "won", "complete", "board_json") SELECT "id", "player_id", "created_on", "completed_on", "score", "won", "complete", "board_json" FROM `game`;--> statement-breakpoint
